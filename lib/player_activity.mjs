...
/** Score payment recency, frequency, and value for campaign segmentation. */
export function scoreRFM({ recencyDays, frequency, monetary }) {
  ...
  const value = f + m;
  return { r, f, m, value, tier: value >= 5 ? 'vip' : value >= 3 ? 'regular' : 'casual' };
}
